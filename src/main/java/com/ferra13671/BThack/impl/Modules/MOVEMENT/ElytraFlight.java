...
public class ElytraFlight extends Module {
    ...
    public static BooleanSetting groundTakeoffFix;
    public static NumberSetting takeoffTime;
    ...
    public static ModeSetting travelMode;
    /////////
    ...
    public ElytraFlight() {
        ...
        groundTakeoffFix = new BooleanSetting("Ground Takeoff Fix", this, true, () -> mode.getValue().equals("Bounce"));
        takeoffTime = new NumberSetting("Takeoff Time", this, 250, 50, 500, true, () -> mode.getValue().equals("Bounce"));
        ...
        downSpeed = new NumberSetting("Down Speed", this, 0.05, 0, 0.1, false, () -> mode.getValue().equals("Firework") && yAlso.getValue() && (stopMode.getValue().equals("Glide") || stopMode.getValue().equals("Jitter")));
        ...
        travelMode = new ModeSetting("Travel Mode", this, Arrays.asList("Rewrite", "Pitch"), () -> mode.getValue().equals("Pitch40"));
        /////////
    ...
    public final TravelChanger travelChanger = new TravelChanger(1000000,
            () -> switch (mode.getValue()) {
                ...
                case "Pitch40" -> new Float[]{mc.player.getYaw(), (travelMode.getValue().equals("Rewrite") ? pitch40pitch : mc.player.getPitch())};
