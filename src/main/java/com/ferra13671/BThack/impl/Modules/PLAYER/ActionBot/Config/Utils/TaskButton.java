...
public class TaskButton extends Button {
    ...
    public void renderButton() {
        ...
        BThackRender.drawString(this.text, (int) (this.getCenterX() - stringWidth), (int) ((heightFactor * 8) + ((heightFactor * offsetFactor) * offset) + (((heightFactor * offsetFactor) / 2) - (mc.textRenderer.fontHeight))), ColorUtils.WHITE);
