...
public class OutdatedVersionWidget extends ScreenWidget {
    ...
    public void init() {
        ...
        buttons.clear();
        buttons.add(Button.of(1, (int) xRight - 70, (int) yUp + 100, 65, 10, "lang.screen.OutdatedVersion.Yes")
        ...
        buttons.add(Button.of(2, (int) xRight - 70, (int) yUp + 100 + 22, 65, 10, "lang.screen.OutdatedVersion.No")
                .withAction(buttonClickInfo -> {
                    BThack.instance.versionInfo.setNeedShowAgainOneRelease(false);
                    close();
                })
        );
        buttons.add(Button.of(3, (int) xRight - 70, (int) yUp + 100 + 44, 65, 10, "lang.screen.OutdatedVersion.AlwaysNo")
                .withAction(buttonClickInfo -> {
