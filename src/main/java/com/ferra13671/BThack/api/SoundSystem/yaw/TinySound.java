package com.ferra13671.BThack.api.SoundSystem.yaw;

import com.ferra13671.BThack.api.SoundSystem.yaw.internal.Mixer;
import com.ferra13671.BThack.api.SoundSystem.yaw.internal.*;
...
public class TinySound {
	...
	/**
	 * Reads all the bytes from an AudioInputStream.
	...
	/**
	 * Reads all the bytes from a 1-channel AudioInputStream.
	 * @param stream the stream to read
	 * @return all bytes from the stream, null if error
	 */
	...
	/**
	 * Reads all the bytes from a 2-channel AudioInputStream.
	 * @param stream the stream to read
	 * @return all bytes from the stream, null if error
	 */
	...
	/**
	 * Read all the bytes from an AudioInputStream.
