...
public class PlaceManager implements Initializable, Mc {
    ...
    public static BlockHitResult getHitResult(BlockPos blockPos, boolean check, Direction direction) {
        com.ferra13671.BThack.managers.managers.Place.FacingBlock block = check ? checkNearBlocksExtended(blockPos) : new com.ferra13671.BThack.managers.managers.Place.FacingBlock(blockPos, direction);
    ...
    public static com.ferra13671.BThack.managers.managers.Place.FacingBlock checkNearBlocksExtended(BlockPos blockPos) {
        com.ferra13671.BThack.managers.managers.Place.FacingBlock ret;
    ...
    public static com.ferra13671.BThack.managers.managers.Place.FacingBlock checkNearBlocks(BlockPos blockPos) {
        ...
        com.ferra13671.BThack.managers.managers.Place.FacingBlock facingBlock = null;
        com.ferra13671.BThack.managers.managers.Place.FacingBlock tempFacingBlock;
